...
public class TableExecutionListenerEditTableEntryDialog extends DialogBox {
	...
	private ExecutionListenerExtensionElement currentExecutionListenerJso;

	public TableExecutionListenerEditTableEntryDialog(
			final TableExecutionListenerWidget widgetCallback,
			ExecutionListenerExtensionElement executionListenerModel) {
		super();
		...
		btnOk.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				if (lboxType.getSelectedItemText().equalsIgnoreCase("script")) {
					ScriptExtensionElementChild scriptJso = currentExecutionListenerJso.setScriptChild();
					...
					currentExecutionListenerJso.removeScriptChild();
				}
