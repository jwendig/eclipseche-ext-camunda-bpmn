...
public class TableExtensionsWidget extends
	...
	public TableExtensionsWidget(BpmnPropertiesView.CurrentJsoAccess jsoAccess) {
				...
				.setFieldUpdater(new FieldUpdater<PropertyExtensionElementChild, String>() {
					...
					public void update(int index,
						...
						getJsoAccess().getCurrentElement()
								.removeExtensionChildElementPropety(object);
		...
		btnAdd.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				PropertyExtensionElementChild newDataObject = getJsoAccess()
						.getCurrentElement().addExtensionChildElementProperty();
	...
	public void update() {
		...
		getDataProvider().getList().addAll(
				getJsoAccess().getCurrentElement().getExtensionChildElementsPropety());
	}
